...
공유 투표는 로그인·연락처 권한 없이 동작합니다. 샌드박스에서는 현재 배포 ID가 포함된 intoss-private:// 테스트 링크를 자동 사용하고, 정식 출시 환경에서는 intoss://replaypick/... 공개 링크를 사용합니다. 친구가 선택하면 토스 공유 시트가 열리고, 친구가 원작성자를 선택해 결과 링크를 보내면 원작성자 앱에서 질문과 선택된 답장을 확인할 수 있습니다.
