...
- 결과 화면 최하단 비침해형 배너 광고: 실제 발급 광고 그룹 ID 사용
...
광고는 결과 화면 하단에서만 표시되며, 모든 환경에서 실제 발급된 `ait.v2.live.8e3c328ace9c4748` 광고 그룹 ID를 사용합니다. 앱인토스 콘솔 QR 테스트에서 배너 로드·클릭·뒤로가기를 확인하세요.
